  ...
  return (
    <div style={{ padding: '1rem', backgroundColor: 'white', minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              />
              <p style={{ fontSize: '0.875rem', fontWeight: '500' }}>Fav Cattles</p>
            </div>
          ...
          {/* Statistics Table */}
          <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1rem' }}>
            <p style={{ fontSize: '1rem', fontWeight: '500', marginBottom: '0.5rem' }}>Recent statistics</p>
        ...
        >
          <p style={{ fontSize: '1rem', fontWeight: '500' }}>Note and Observation</p>
          <textarea
            style={{
              height: '8rem',
              border: '1px solid #d1d5db',
          ...
          />
          <div style={{ display: 'flex', fontSize:'20px', flexDirection: 'column', gap: '0.5rem' }}>
            <label><input type="checkbox" style={{ marginRight: '0.5rem' }} /> Health update</label>
            <label><input type="checkbox" style={{ marginRight: '0.5rem' }} /> Treatment Records</label>
            <label><input type="checkbox" style={{ marginRight: '0.5rem' }} /> Temperature</label>
            <label><input type="checkbox" style={{ marginRight: '0.5rem' }} /> Farmer Feedback</label>
          </div>
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            <button style={{ backgroundColor: '#16a34a', color: 'white', padding: '0.5rem 1rem', borderRadius: '0.375rem', width:"130px" }}>Save</button>
            <button style={{ border: '1px solid #d1d5db', padding: '0.5rem 1rem', borderRadius: '0.375rem',width:"130px" }}>Clear</button>
          </div>
        </div>
      </div>
    </div>
