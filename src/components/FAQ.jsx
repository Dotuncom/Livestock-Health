...
function FAQ() {
  const xml = (
    <>
      <h2 id='faq' className='text-center font-[Poppins] font-semibold text-[4rem] leading-[9rem] mb-[3rem] max-lg:text-[2.4rem] max-lg:leading-[3rem] max-lg:text-center max-lg:text-[#0F0E0E] max-lg:mb-[1rem] max-lg:pt-[3.4rem]'>
