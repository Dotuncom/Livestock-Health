...
function SignUpForm() {
  ...
  const xml = (
    <form className='w-full  h-full flex flex-col items-center justify-center [>]:flex-none ss'>
      ...
      />
      <div className=' max-md:mb-0 mb-[1.5rem] custom-mb'></div>
      <div className='w-[53.8rem] max-w-[90%] flex gap-[1.1rem] max-md:mb-[1rem] mb-[2.2rem] custom-b-mb'>
        <input
          type='checkbox'
          name='terms'
          className='w-[2rem] aspect-square'
        />
        <span className='font-[Inter] not-italic font-medium max-md:text-[1.4rem] text-[2rem] leading-[2.4rem] text-[#121212]'>
